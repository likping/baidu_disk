class utils {
  static String getDateTime(int server_ctime){
    var time=DateTime.fromMillisecondsSinceEpoch(server_ctime);
  ...
  static String getParentPath(String _currentPath){
    return "/";
  }
  static String getCurrPathFileName(_currPath){
    return "1";
  }
